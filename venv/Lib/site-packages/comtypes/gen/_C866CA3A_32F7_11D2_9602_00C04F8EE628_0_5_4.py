...
__all__ = [
    ...
    'eLEXTYPE_RESERVED8', 'DISPID_SAFType',
    'DISPID_SLRemovePronunciation', 'WAVEFORMATEX',
    'DISPID_SpeechPhoneConverter', 'SPAR_Unknown',
    'eLEXTYPE_PRIVATE14', 'SpAudioFormat', 'SpResourceManager',
    'ISpeechLexiconPronunciation', 'SpeechCategoryAudioIn',
    'DISPID_SPIProperties', 'DISPID_SVVolume', 'eWORDTYPE_ADDED',
    'SP_VISEME_17', 'SpObjectTokenCategory', 'DISPID_SPPId',
    'SAFTNonStandardFormat', 'SPWT_LEXICAL', 'DISPID_SRCEHypothesis',
    'UINT_PTR', 'SPEI_END_INPUT_STREAM', 'DISPID_SVEStreamEnd',
    'SPVOICESTATUS', 'DISPID_SVGetProfiles',
    'SpeechGrammarTagDictation', 'SVEWordBoundary',
    'DISPID_SpeechAudio', 'STSF_LocalAppData',
    'DISPID_SpeechPhraseAlternates', 'SP_VISEME_15',
    'SPWORDPRONUNCIATION', 'DISPID_SDKSetLongValue',
    'DISPID_SPEDisplayText', 'DISPID_SRRDiscardResultInfo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpPhraseAlt',
    'DISPID_SpeechLexiconProns', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SGDSInactive', 'SRTEmulated', 'SPEI_ADAPTATION',
    'DISPID_SVStatus', 'DISPID_SVSLastResult', 'SP_VISEME_9',
    'SpCompressedLexicon', 'DISPID_SGRClear', 'SPRST_NUM_STATES',
    'DISPID_SpeechPhraseProperties', 'ISpeechGrammarRules',
    'DISPID_SRGId', 'ISpRecognizer2', 'SpeechAudioFormatGUIDWave',
    'DISPID_SDKGetlongValue', 'DISPID_SOTMatchesAttributes',
    'SAFT11kHz8BitMono', 'SAFT22kHz8BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechDataKey', 'DISPID_SOTCId',
    'DISPID_SRCERecognitionForOtherContext', 'SP_VISEME_2',
    'DISPID_SVGetVoices', 'SVP_18', 'SSSPTRelativeToCurrentPosition',
    'SAFTGSM610_44kHzMono', 'DISPID_SVRate', 'ISpeechPhraseAlternate',
    'SLTUser', '__MIDL_IWinTypes_0009', 'DISPID_SRIsUISupported',
    'DISPID_SOTCreateInstance', 'SPDKL_CurrentConfig', 'SPWF_INPUT',
    'SPDKL_CurrentUser', 'eWORDTYPE_DELETED', 'ISpVoice',
    'ISpeechMemoryStream', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPParent', 'SVP_14', 'DISPID_SPARecoResult',
    'SP_VISEME_21', 'ISpRecoContext', 'SPFM_NUM_MODES', 'SLODynamic',
    'SPEI_VOICE_CHANGE', 'SpeechStreamFileMode', 'DISPID_SLPsCount',
    'DISPID_SPIGrammarId', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechPhraseAlternate', 'SPEI_SOUND_END',
    'DISPID_SRCRecognizer', 'DISPID_SpeechPhraseElements',
    'SPPARTOFSPEECH', 'ISpeechPhraseElement', 'STCInprocHandler',
    'SRADefaultToActive', 'DISPID_SPERequiredConfidence',
    'SVSFIsNotXML', 'SRSInactiveWithPurge', 'DISPID_SVAudioOutput',
    'DISPID_SRGSetTextSelection', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRsCommit', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechVoiceStatus', 'SVSFNLPMask', 'SECFDefault',
    'DISPID_SPAs_NewEnum', 'SBONone', 'DISPID_SRCState',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGRules',
    'DISPID_SRProfile', 'SWTDeleted', 'eLEXTYPE_PRIVATE10',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVGetAudioInputs',
    'SVPNormal', 'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SWFEChannels',
    'SRAORetainAudio', 'ISpeechPhraseReplacement',
    'SAFTADPCM_44kHzStereo', 'DISPID_SGRsCount',
    'ISpeechAudioBufferInfo', 'SpeechCategoryRecoProfiles',
    'ISpStreamFormatConverter', 'SpMMAudioIn', 'SpMMAudioEnum',
    'DISPID_SWFEFormatTag', 'SPPS_Unknown',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVSLastBookmarkId',
    'ISpNotifyTranslator', 'SAFT44kHz16BitStereo', 'SAFT8kHz8BitMono',
    'SPEI_RESERVED5', 'SpMemoryStream', 'DISPID_SPRs_NewEnum',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE7', 'DISPID_SVPriority',
    'DISPID_SPIRule', 'DISPID_SRGDictationLoad', 'DISPID_SLWType',
    'SGRSTTDictation', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechPhraseRules', 'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_1',
    'eLEXTYPE_USER_SHORTCUT', 'SGRSTTWord', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRsCommitAndSave', 'SPFM_CREATE_ALWAYS',
    'DISPID_SMSSetData', 'SPEI_MIN_TTS', 'DISPID_SRCEBookmark',
    'SVEPrivate', 'DISPID_SRSetPropertyString', 'DISPID_SVSkip',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpSerializeState',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRRecognizer',
    'SpeechDiscardType', 'SSTTTextBuffer',
    'DISPID_SRGCmdSetRuleState', 'SAFTNoAssignedFormat',
    'DISPID_SDKDeleteValue', 'SpeechDisplayAttributes',
    'DISPID_SGRAddState', 'SREAllEvents',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_PHONEME',
    'SPEI_RECOGNITION', 'DISPID_SRState', 'SASClosed',
    'SAFT16kHz16BitStereo', 'SpeechPropertyResourceUsage',
    'SpeechDictationTopicSpelling', 'SpeechUserTraining',
    'SPDKL_LocalMachine', 'ISpRecoContext2',
    'SAFTCCITT_uLaw_44kHzMono', 'SPGS_EXCLUSIVE', 'SGSDisabled',
    'eLEXTYPE_PRIVATE11', 'SVEVoiceChange', 'SpeechVoicePriority',
    'Speech_Max_Word_Length', 'SAFT8kHz16BitMono',
    'SpeechPropertyAdaptationOn', 'SREAudioLevel',
    'SPINTERFERENCE_NOSIGNAL', 'SPAS_CLOSED', 'SPRST_INACTIVE',
    'DISPID_SRRAlternates', 'SpeechCategoryAudioOut',
    'SAFTADPCM_22kHzMono', 'SPSHT_Unknown', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SDKGetBinaryValue',
    ...
    'SDTRule', 'DISPID_SRGRecoContext', 'SPEI_SR_BOOKMARK',
    'DISPID_SRCEEndStream', 'DISPID_SpeechVoice', 'SPDATAKEYLOCATION',
    'DISPID_SLPs_NewEnum', 'SAFT8kHz8BitStereo', 'DISPID_SGRSTRule',
    'SpeechSpecialTransitionType', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpObjectToken', 'DISPID_SLWsCount', 'DISPID_SPCPhoneToId',
    'DISPID_SRCBookmark', 'SPPROPERTYINFO', 'SpPhraseInfoBuilder',
    'SVSFVoiceMask', 'SpeechAudioFormatType', 'SPEI_REQUEST_UI',
    'SRARoot', 'DISPID_SPIEnginePrivateData', 'DISPID_SLWsItem',
    'SITooQuiet', 'SAFT12kHz16BitMono', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPRuleId', 'SRERecoOtherContext',
    'SPWORDPRONUNCIATIONLIST', 'SPPS_Function',
    'DISPID_SPIAudioSizeBytes', 'SPWORDLIST', 'SpeechRecoEvents',
    'SFTSREngine', 'ISpeechLexiconPronunciations',
    'SAFT48kHz8BitMono', 'SGDSActiveWithAutoPause',
    'DISPID_SMSAMMHandle', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCEEnginePrivate', 'SGLexical',
    'DISPID_SRGSetWordSequenceData', 'SPEI_RESERVED1',
    'ISpRecognizer', 'eLEXTYPE_RESERVED9', 'SPFILEMODE',
    'DISPID_SVEVoiceChange', 'DISPID_SRSClsidEngine',
    'SAFT32kHz16BitMono', 'ISpPhoneticAlphabetConverter',
    'SPRECORESULTTIMES', 'SpeechAddRemoveWord',
    'DISPID_SRCEPropertyNumberChange', 'SVEEndInputStream',
    'DISPID_SABIEventBias', 'SPCT_SLEEP', 'DISPID_SRRTLength',
    'SAFT11kHz16BitStereo', 'SGDSActiveUserDelimited',
    'ISpStreamFormat', 'DISPID_SpeechLexicon', 'SFTInput',
    'DISPID_SRCEInterference', 'SPINTERFERENCE_NOISE',
    'DISPID_SPRFirstElement', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPEs_NewEnum', 'SECFIgnoreCase', 'DISPID_SLPPhoneIds',
    'SVP_8', 'SpeechGrammarState', 'eLEXTYPE_APP', 'SPCS_DISABLED',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVSInputWordLength',
    'SPFM_CREATE', 'DISPID_SGRsItem', 'SVSFIsXML',
    'SSFMCreateForWrite', 'DISPID_SPRulesItem', 'DISPID_SGRSTsItem',
    'SPEI_PHRASE_START', 'SPWORD', 'SAFTGSM610_11kHzMono',
    'SAFTDefault', 'SPCONTEXTSTATE', 'DISPID_SRRAudioFormat',
    'DISPID_SVSCurrentStreamNumber', 'SPSMF_SAPI_PROPERTIES',
    'SPINTERFERENCE_TOOFAST', 'SPTEXTSELECTIONINFO',
    ...
    'SECFEmulateResult', 'SECLowConfidence', 'SpStream',
    '_ISpeechVoiceEvents', 'SP_VISEME_10', 'SpeechRuleAttributes',
    ...
    'SAFTCCITT_uLaw_44kHzStereo', 'SPWT_DISPLAY', 'SPINTERFERENCE',
    'SP_VISEME_6', 'SPGS_ENABLED', 'SRTAutopause', 'DISPID_SOTsCount',
    'DISPID_SOTCDefault', 'SVEAllEvents', 'DISPID_SCSBaseStream',
    'SPLO_DYNAMIC', 'SVSFParseMask', 'SDKLCurrentUser',
    'SpeechTokenKeyUI', 'SREAdaptation',
    'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechObjectTokenCategory', 'SVSFIsFilename',
    'DISPID_SABIBufferSize', 'SAFT48kHz8BitStereo',
    'SpeechCategoryRecognizers', 'SVP_0', 'SpFileStream',
    'SPSERIALIZEDRESULT', 'DISPID_SPIStartTime', 'DISPID_SAVolume',
    'SREPropertyStringChange', 'SPPS_Interjection',
    'eLEXTYPE_RESERVED4', 'SASPause', 'SGPronounciation',
    'SVSFParseAutodetect', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SOTCGetDataKey', 'DISPID_SpeechWaveFormatEx',
    'SP_VISEME_19', 'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE4',
    ...
    'DISPID_SVSLastBookmark', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPRulesCount', 'DISPID_SMSADeviceId',
    'SAFT12kHz8BitStereo', 'tagSTATSTG', 'SP_VISEME_3',
    'DISPID_SVVoice', 'SECNormalConfidence',
    'DISPID_SpeechPhraseRules', 'SREHypothesis',
    'DISPID_SDKEnumValues', 'SpeechAllElements', 'SRERecognition',
    'ISpeechRecoContext', 'SpMMAudioOut', 'SP_VISEME_4',
    'SPINTERFERENCE_TOOSLOW', 'SGRSTTEpsilon', 'SPSNotOverriden',
    'STSF_AppData', 'DISPID_SPPEngineConfidence', 'SPAUDIOSTATE',
    'DISPIDSPRG', 'DISPID_SRGCmdSetRuleIdState', 'SpeechFormatType',
    'SDA_Consume_Leading_Spaces', 'ISpMMSysAudio', 'SINone',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPPNumberOfElements',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRRAudio',
    'eLEXTYPE_PRIVATE15', 'SPEI_TTS_PRIVATE', 'SAFT16kHz16BitMono',
    'SRADynamic', 'DISPID_SGRSTs_NewEnum', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechAudioStatus', 'SPLEXICONTYPE',
    'SAFT32kHz16BitStereo', 'SpShortcut', 'ISpEventSource',
    'DISPID_SRCERecognizerStateChange',
    'SpeechPropertyComplexResponseSpeed', 'SpNotifyTranslator',
    'SPAO_NONE', 'DISPID_SRCESoundEnd', 'ISpProperties',
    'ISpeechBaseStream', 'ISpeechCustomStream',
    'SpeechBookmarkOptions', 'DISPID_SRRSpeakAudio',
    'ISpeechObjectTokenCategory', 'SPINTERFERENCE_NONE',
    'DISPID_SpeechGrammarRules', 'SPRECOGNIZERSTATUS', 'SPAR_Medium',
    'SRATopLevel', 'SPGS_DISABLED',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCEFalseRecognition', 'SPPS_RESERVED2',
    'SVESentenceBoundary', 'SPSInterjection', 'SPPS_NotOverriden',
    'ISpeechPhoneConverter', 'SPADAPTATIONRELEVANCE', 'SREPrivate',
    'DISPID_SRGIsPronounceable', 'DISPID_SAFGuid',
    ...
    'DISPID_SRSAudioStatus', 'SPEI_MAX_SR', 'DISPID_SPRuleParent',
    'ISpeechRecognizerStatus', 'SVEPhoneme', 'DISPID_SLPsItem',
    'DISPID_SPCLangId', 'SDTDisplayText', 'DISPID_SpeechLexiconWord',
    'SPAR_Low', 'DISPID_SRCVoice', 'SpeechWordType', 'SPPS_RESERVED4',
    'DISPID_SGRsFindRule', '_RemotableHandle',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SGSEnabled', 'SGDSActive',
    'SPAUDIOBUFFERINFO', 'ISpStream', 'SPPHRASE', 'SPVPRI_NORMAL',
    'DISPID_SRGetPropertyString', 'SVP_4',
    'DISPID_SpeechLexiconWords', 'SPSMF_UPS', 'SVP_3', 'SPAS_STOP',
    'SRCS_Enabled', 'SRAExport', 'SRAImport', 'DISPID_SRCPause',
    'DISPID_SpeechPhraseRule', 'IEnumSpObjectTokens',
    'SpSharedRecognizer', 'SpInprocRecognizer', 'ISpResourceManager',
    'SPSHORTCUTPAIR', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eLEXTYPE_PRIVATE2', 'SPRST_ACTIVE',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechRecoResultTimes',
    'DISPID_SpeechMemoryStream', 'DISPID_SRGetRecognizers',
    'ISpPhoneConverter', 'SPPHRASEELEMENT',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPPs_NewEnum',
    'SPEI_HYPOTHESIS', 'SVEAudioLevel', 'DISPID_SMSGetData',
    'ISequentialStream', 'SpeechTokenKeyFiles',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRTTickCount',
    'DISPID_SVSpeak', 'DISPID_SPELexicalForm',
    'DISPID_SAFGetWaveFormatEx', 'SAFT24kHz16BitMono',
    'SPSHORTCUTTYPE', 'DISPID_SpeechObjectToken', 'DISPID_SGRSTType',
    'ISpeechGrammarRuleState', 'ISpDataKey', 'DISPID_SVEBookmark',
    'DISPID_SVEPhoneme', 'SpeechVisemeType',
    'SpStreamFormatConverter', 'SDA_Two_Trailing_Spaces',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVDisplayUI',
    'SPWT_PRONUNCIATION', 'SAFT48kHz16BitStereo',
    'SVEStartInputStream', 'DISPID_SWFEBlockAlign',
    'SAFT32kHz8BitMono', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechCategoryAppLexicons', 'DISPID_SRAudioInputStream',
    'DISPID_SRCRetainedAudioFormat', 'SPBO_TIME_UNITS',
    'SPFM_OPEN_READWRITE', 'SPSHT_EMAIL', 'SPEI_RESERVED6',
    'SRCS_Disabled', 'DISPID_SOTGetStorageFileName', 'SRSEDone',
    'SPSNoun', 'SpeechPropertyHighConfidenceThreshold',
    'ISpRecognizer3', 'DISPID_SRDisplayUI',
    'DISPID_SPRNumberOfElements', 'SDTPronunciation',
    'DISPID_SRGCmdLoadFromMemory', 'SPPS_RESERVED3', 'SPEI_VISEME',
    'DISPID_SpeechRecoContext', 'SpNullPhoneConverter',
    'SPAUDIOSTATUS', 'SAFT11kHz8BitStereo',
    'DISPID_SPERetainedSizeBytes', 'SPEI_SOUND_START',
    'DISPID_SLGenerationId', 'SAFT48kHz16BitMono', 'SGSExclusive',
    'SVP_15', 'SDKLDefaultLocation', 'SRTStandard',
    'SWPUnknownWordPronounceable', 'SpLexicon',
    'DISPID_SpeechAudioBufferInfo', 'SAFTADPCM_11kHzStereo',
    'SpeechAudioVolume', 'SAFTGSM610_22kHzMono', 'SPBINARYGRAMMAR',
    'SAFT22kHz16BitMono', 'SpeechEngineConfidence', 'SPRULE',
    'DISPID_SRGDictationSetState', 'DISPID_SRCVoicePurgeEvent',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFTADPCM_11kHzMono',
    'DISPID_SVAudioOutputStream', 'SpeechLoadOption', 'SPRECOSTATE',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPPS_Noun', 'SDTReplacement',
    'ISpRecoResult', 'LONG_PTR', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechPartOfSpeech', 'DISPID_SPPsCount', 'SDTProperty',
    'SINoise', 'SREStreamEnd', 'DISPID_SAEventHandle', 'SP_VISEME_0',
    'DISPID_SpeechPhraseElement', 'SSSPTRelativeToEnd',
    'ISpeechRecoResult', 'DISPID_SRGDictationUnload', 'SPVPRI_OVER',
    'ISpNotifySink', 'DISPID_SpeechRecoResultTimes',
    'eLEXTYPE_RESERVED7', 'SpeechVoiceSpeakFlags',
    'DISPID_SRRPhraseInfo', 'SVSFPersistXML', 'SP_VISEME_16',
    'DISPID_SPIReplacements', 'DISPID_SOTsItem',
    'DISPID_SRRRecoContext', 'SVP_19', 'DISPID_SRGetFormat',
    'SpeechRegistryUserRoot', 'DISPID_SOTDisplayUI',
    'SPEI_END_SR_STREAM', 'DISPID_SRCERecognition', 'SITooLoud',
    'DISPID_SBSSeek', 'eLEXTYPE_PRIVATE9', 'SPAUDIOOPTIONS',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SDKDeleteKey',
    'DISPID_SRAudioInput', 'SPEI_MAX_TTS', 'DISPID_SPEPronunciation',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRStatus',
    'DISPID_SASNonBlockingIO', 'DISPID_SLWWord',
    'DISPIDSPTSI_SelectionLength', 'SAFT16kHz8BitMono', 'SVP_17',
    'SPCT_DICTATION', 'SpCustomStream', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechCategoryVoices', 'ISpeechObjectTokens',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechObjectTokens', 'SpVoice',
    'DISPID_SpeechAudioFormat', 'SRTReSent', 'SPLOADOPTIONS',
    'SPCATEGORYTYPE', 'SRTSMLTimeout', 'SpeechWordPronounceable',
    'DISPID_SPAsCount', 'SDA_One_Trailing_Space',
    'DISPID_SPIGetDisplayAttributes', 'SPPS_Noncontent',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRRTStreamTime',
    'SPSERIALIZEDPHRASE', 'SpeechAudioProperties',
    'DISPID_SOTGetDescription', 'ISpeechAudioFormat',
    'DISPID_SDKCreateKey', 'SP_VISEME_13', 'SECFIgnoreWidth',
    'DISPID_SGRSTText', 'DISPID_SGRSTNextState', 'SITooSlow',
    'SPVISEMES', 'DISPID_SRCEAdaptation', 'SAFT11kHz16BitMono',
    'SSFMOpenReadWrite', 'ISpRecoGrammar2', 'SVP_2', 'SVSFlagsAsync',
    'SPSHORTCUTPAIRLIST', 'ISpeechWaveFormatEx',
    'ISpeechTextSelectionInformation',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPEActualConfidence',
    'SPFM_OPEN_READONLY', 'SINoSignal', 'SECFNoSpecialChars',
    'SPCT_COMMAND', 'SpeechRecoProfileProperties',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRCCmdMaxAlternates',
    'SpeechEngineProperties', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFTADPCM_8kHzStereo', 'SDA_No_Trailing_Space',
    'DISPID_SpeechBaseStream', 'ISpeechPhraseRule', 'ISpRecoCategory',
    'SPAS_RUN', 'eLEXTYPE_PRIVATE12', 'DISPID_SDKOpenKey',
    'SpeechVisemeFeature', 'DISPID_SPERetainedStreamOffset',
    'SSSPTRelativeToStart', 'SpeechLexiconType',
    'DISPID_SpeechDataKey', 'SVP_21', 'DISPID_SRCSetAdaptationData',
    'ISpeechPhraseElements', 'SPSEMANTICFORMAT',
    'SREFalseRecognition', 'SREStreamStart', 'SPEI_START_SR_STREAM',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechLexiconPronunciation', 'SAFT24kHz16BitStereo',
    'SPWF_SRENGINE', 'SREPropertyNumChange', 'SpeechRecoContextState',
    'SDTAll', 'Speech_Default_Weight', 'Speech_StreamPos_Asap',
    'tagSPPROPERTYINFO', 'DISPID_SGRAttributes', 'SVP_6',
    'SGRSTTRule', 'DISPID_SBSWrite', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechFileStream', 'SP_VISEME_8', 'SGRSTTWildcard',
    'DISPID_SVWaitUntilDone', 'DISPID_SOTGetAttribute', 'SAFTText',
    'SPSUnknown', 'DISPID_SLWs_NewEnum', 'SAFT44kHz16BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRGCommit',
    'DISPID_SGRSTWeight', 'DISPID_SFSClose', 'SAFT44kHz8BitMono',
    ...
    'DISPID_SpeechXMLRecoResult', 'SVP_11', 'ISpXMLRecoResult',
    'ISpeechRecoResultDispatch', 'SRESoundStart', 'SPWAVEFORMATTYPE',
    'ISpPhoneticAlphabetSelection', 'SASStop', 'DISPID_SPCIdToPhone',
    'DISPID_SASetState', 'ISpObjectWithToken', 'SVP_13',
    'SREStateChange', 'SpeechTokenContext', 'SVSFParseSsml',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechPhraseReplacements',
    'DISPID_SAFSetWaveFormatEx', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechPhraseBuilder', 'IInternetSecurityMgrSite',
    'SRAInterpreter', 'DISPID_SRCEventInterests',
    'eLEXTYPE_PRIVATE17', 'SPSFunction', 'DISPID_SVIsUISupported',
    ...
    'STCInprocServer', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SBSFormat',
    'STSF_FlagCreate', 'SPLO_STATIC', 'SPEI_INTERFERENCE',
    'DISPID_SPRules_NewEnum', 'SP_VISEME_7', 'SDKLCurrentConfig',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechDataKeyLocation',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRSTPropertyId',
    'DISPID_SRRSaveToMemory', 'SpeechCategoryPhoneConverters',
    'SpeechTokenIdUserLexicon', 'SAFT12kHz8BitMono', 'DISPID_SLPType',
    'DISPID_SVEWord', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_RESERVED3', 'SPSVerb', 'SPRS_INACTIVE',
    'DISPID_SPAPhraseInfo', 'DISPID_SGRAddResource',
    'ISpeechVoiceStatus', 'SPPS_SuppressWord',
    'SPDKL_DefaultLocation', 'DISPID_SRRTOffsetFromStart',
    'ISpGrammarBuilder', 'DISPID_SRCERequestUI',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPRuleConfidence',
    'DISPID_SLGetGenerationChange', 'SASRun',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT22kHz8BitMono',
    'DISPID_SGRInitialState', 'DISPID_SVEEnginePrivate',
    'SVF_Emphasis', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPIAudioStreamPosition', 'SDTAlternates', 'DISPID_SGRId',
    'DISPID_SMSALineId', 'SpeechStreamSeekPositionType',
    'SSTTDictation', 'DISPID_SWFEBitsPerSample', 'SSFMOpenForRead',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE6', 'DISPID_SVSPhonemeId',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechGrammarRule',
    'SpWaveFormatEx', 'SWTAdded', 'SPEVENT', 'STCLocalServer',
    'SVSFNLPSpeakPunc', 'DISPID_SGRs_NewEnum',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKEnumKeys',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVSVisemeId',
    'ISpeechPhraseProperties', 'DISPID_SPACommit', 'SVP_5',
    'DISPID_SPISaveToMemory', 'DISPID_SVResume', 'ISpeechRecoGrammar',
    'SPXRO_Alternates_SML', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVEStreamStart',
    'DISPID_SRSetPropertyNumber', 'DISPID_SFSOpen', 'SPSModifier',
    ...
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRGetXMLResult',
    'SREPhraseStart', 'DISPID_SOTIsUISupported', 'DISPID_SPRsCount',
    'DISPID_SpeechCustomStream', 'SPGRAMMARSTATE', 'DISPID_SPRsItem',
    'SVSFPurgeBeforeSpeak', 'DISPID_SLGetWords',
    'DISPID_SGRSAddSpecialTransition', 'STSF_CommonAppData',
    'DISPID_SPIElements', 'SSFMCreate', 'DISPID_SLAddPronunciation',
    'ISpeechRecoResult2', 'SVEBookmark', 'DISPID_SGRSTPropertyName',
    'SGDisplay', '_ISpeechRecoContextEvents',
    'SpeechPropertyNormalConfidenceThreshold', 'SVPOver',
    'DISPID_SpeechFileStream', 'DISPID_SPAStartElementInResult',
    'DISPID_SPAsItem', 'eLEXTYPE_RESERVED10',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechPropertyResponseSpeed',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SBSRead', 'SDTLexicalForm',
    'SPEVENTENUM', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SLPSymbolic',
    'ISpeechPhraseInfoBuilder', 'SRSEIsSpeaking', 'IEnumString',
    'DISPID_SPPName', 'SPPS_LMA', 'Speech_StreamPos_RealTime',
    'DISPID_SGRSTransitions', 'eLEXTYPE_MORPHOLOGY', 'SITooFast',
    'DISPID_SGRsAdd', 'SAFT24kHz8BitStereo',
    'DISPIDSPTSI_SelectionOffset', 'ISpObjectToken',
    'SpeechRetainedAudioOptions', 'ISpRecoGrammar',
    'SGRSTTTextBuffer', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPVPRIORITY', 'SRERequestUI', 'eLEXTYPE_PRIVATE5',
    'SpUnCompressedLexicon', 'ISpeechVoice', 'STCRemoteServer',
    'DISPID_SVPause', 'SVP_9', 'SAFT8kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRGReset', 'SP_VISEME_5', 'SpeechEmulationCompareFlags',
    'DISPID_SWFESamplesPerSec', 'SAFTGSM610_8kHzMono',
    'SpeechRuleState', 'SECHighConfidence', 'DISPID_SpeechRecognizer',
    'SP_VISEME_18', 'DISPID_SPRDisplayAttributes',
    'SRTExtendableParse', 'SVSFUnusedFlags', 'eLEXTYPE_LETTERTOSOUND',
    'SPSLMA', 'DISPID_SPEAudioSizeTime', 'SPEI_RESERVED2',
    'DISPID_SLWPronunciations', '_SPAUDIOSTATE', 'DISPID_SOTSetId',
    'DISPID_SPPChildren', 'SpeechGrammarTagWildcard', 'SPBO_PAUSE',
    'SPCS_ENABLED', 'SVP_7', 'DISPID_SRCESoundStart', 'SRESoundEnd',
    'SVP_16', 'SVSFDefault', 'SPEI_UNDEFINED', 'DISPID_SPEsItem',
    'SPWORDTYPE', 'SGLexicalNoSpecialChars',
    'DISPID_SPEEngineConfidence', 'SpeechRegistryLocalMachineRoot',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechAudio', 'DISPID_SGRName',
    'SP_VISEME_20', 'SVPAlert', 'SDTAudio', 'ISpAudio', 'SREBookmark',
    'SPPHRASERULE', 'DISPID_SVSRunningState', 'SpeechMicTraining',
    'DISPID_SPRuleEngineConfidence', 'eLEXTYPE_USER',
    'DISPID_SPPValue', 'DISPID_SVEAudioLevel', 'SpeechInterference',
    'DISPID_SRRTimes', 'SVEViseme', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPRuleChildren', 'SpeechTokenKeyAttributes',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechPhraseProperty',
    'SP_VISEME_11', 'SP_VISEME_14', 'Speech_Max_Pron_Length',
    'ISpNotifySource', 'SSTTWildcard', 'SpInProcRecoContext',
    'DISPID_SOTId', 'SPVPRI_ALERT', 'SPRECOCONTEXTSTATUS',
    'DISPID_SOTCSetId', 'DISPID_SOTCEnumerateTokens', 'ISpPhrase',
    'SpTextSelectionInformation', 'DISPID_SADefaultFormat',
    'DISPIDSPTSI', 'ISpeechLexiconWords', 'DISPID_SpeechRecoResult',
    ...
    'DISPID_SLWLangId', 'SPXMLRESULTOPTIONS', 'SpeechGrammarWordType',
    'SREInterference', 'DISPID_SLPLangId', 'SVP_1',
    'SpeechVoiceEvents', 'IStream',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SBOPause',
    'DISPID_SWFEExtraData', 'DISPID_SPEDisplayAttributes',
    'ISpeechRecognizer', 'DISPID_SPRuleName',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE19',
    'SpeechRecognizerState', 'SpeechRunState', 'SPPS_Modifier',
    'DISPID_SABIMinNotification', 'SPSHT_NotOverriden',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_MIN_SR', 'eLEXTYPE_PRIVATE1', 'SWPKnownWordPronounceable',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_PRIVATE3',
    'DISPID_SDKSetStringValue', 'ISpeechMMSysAudio', 'SVF_Stressed',
    'ISpeechGrammarRuleStateTransition', 'SPPHRASEREPLACEMENT',
    'DISPID_SPIEngineId', 'SPBOOKMARKOPTIONS', 'STCAll', 'SLOStatic',
    'DISPID_SOTCategory', 'SPBO_NONE', 'SRAONone', 'SPSSuppressWord',
    'SRSInactive', 'DISPID_SAStatus', 'SPCT_SUB_COMMAND',
    'DISPID_SOTDataKey', 'ISpeechXMLRecoResult', 'SPPS_RESERVED1',
    'SLTApp', 'SDKLLocalMachine', 'DISPID_SpeechPhraseReplacements',
    'SAFT22kHz16BitStereo', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRSTsCount', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPPS_Verb', 'ISpeechPhraseProperty', 'SPAR_High',
    'DISPID_SPILanguageId', 'DISPID_SVSpeakStream', 'SP_VISEME_12',
    'ISpeechLexiconWord', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRSCurrentStreamPosition', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SGRSRule', 'DISPID_SPIAudioSizeTime', 'DISPID_SRCResume',
    'IInternetSecurityManager', 'ISpeechObjectToken', 'SPBO_AHEAD',
    'SVP_20', 'SpeechAudioState', 'DISPID_SPEAudioSizeBytes',
    'ISpeechResourceLoader', 'DISPID_SRGCmdLoadFromFile',
    'ISpeechLexicon', 'SAFT24kHz8BitMono',
    'DISPID_SLGetPronunciations', 'ISpLexicon',
    ...
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCCreateGrammar', 'SRSActive',
    'ISpEventSink', 'eLEXTYPE_VENDORLEXICON', 'SPRS_ACTIVE',
    'DISPID_SPRText', 'SAFT44kHz8BitStereo', 'SpeechTokenValueCLSID',
    'SPXRO_SML', 'SPAS_PAUSE', 'DISPID_SPPsItem', 'ISpShortcut',
    'SVSFParseSapi', 'eLEXTYPE_PRIVATE13', 'ISpeechPhraseAlternates',
    'SVP_10', 'SPSHT_OTHER'
]
